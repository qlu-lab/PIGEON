...
from ldsc_mod import sumstats
from pigeon import TopHEAD, Logger, sec_to_str
import time
...
try:
    ...
    raise ImportError('PIGEON requires pandas version >= 0.17.0')
...
def allele_merge(dat, alleles, log):
    ...
    dat.loc[(jj!=True), [i for i in dat.columns if i != 'SNP']] = float('nan')
...
parser.add_argument('--snp', default=None, type=str,
                    help='Name of SNP column (if not a name that PIGEON understands). NB: case insensitive.')
parser.add_argument('--N-col', default=None, type=str,
                    help='Name of N column (if not a name that PIGEON understands). NB: case insensitive.')
...
parser.add_argument('--a1', default=None, type=str,
                    help='Name of A1 column (if not a name that PIGEON understands). NB: case insensitive.')
parser.add_argument('--a2', default=None, type=str,
                    help='Name of A2 column (if not a name that PIGEON understands). NB: case insensitive.')
parser.add_argument('--p', default=None, type=str,
                    help='Name of p-value column (if not a name that PIGEON understands). NB: case insensitive.')
parser.add_argument('--frq', default=None, type=str,
                    help='Name of FRQ or MAF column (if not a name that PIGEON understands). NB: case insensitive.')
...
parser.add_argument('--info', default=None, type=str,
                    help='Name of INFO column (if not a name that PIGEON understands). NB: case insensitive.')
...
parser.add_argument('--nstudy', default=None, type=str,
                    help='Name of NSTUDY column (if not a name that PIGEON understands). NB: case insensitive.')
